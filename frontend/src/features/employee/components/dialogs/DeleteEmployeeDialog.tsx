      ...
      <div className="relative z-10 w-full max-w-sm bg-white dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-[14px] font-semibold text-zinc-900 dark:text-zinc-100">Delete Employee</h3>
          ...
          <div className="space-y-3 mb-6">
            <div className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800">
              <p className="text-[12px] text-zinc-500 dark:text-zinc-400 mb-1 font-medium uppercase tracking-wider">Employee to delete</p>
              <p className="text-[14px] font-semibold text-zinc-900 dark:text-zinc-100">
                {employee.khmerName || employee.englishName || 'Unnamed Employee'}
              </p>
              <p className="text-[11px] text-zinc-400 dark:text-zinc-500">{employee.employeeCode || 'No Code'}</p>
            </div>
            <p className="text-[12px] text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Are you sure you want to delete this employee? All associated records will be permanently removed.
            </p>
          </div>
