...
/**
 * Main menu with PO / KPI report options.
 */
export const mainMenu = () => ({
  reply_markup: {
    inline_keyboard: [
      [
        { text: '📊 Daily PO Snapshot', callback_data: 'daily_menu' },
        { text: '📈 Weekly Rankings', callback_data: 'weekly_menu' },
      ],
      [
        { text: '📋 Monthly Depot KPI', callback_data: 'monthly_menu' },
