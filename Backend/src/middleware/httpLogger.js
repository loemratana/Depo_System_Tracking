...
// (method, path, statusCode, duration, requestId — requestId is injected
// automatically by the logger's context format, see config/logger.js) plus
// an optional slow-request warning. Health/metrics polling is skipped to
// avoid drowning real traffic in noise.
